...
public class TestData
{
    ...
    public async Task InitializeAsync()
    {
        ...
        {
            Id = (Guid) (await source.Partition.GetKeyForInstanceAsync<PartitionByReportingNode>(args)),
            ReportingNode = args.ReportingNode
        };

        partition = new PartitionByReportingNodeAndPeriod
        {
            Id = (Guid) (await source.Partition.GetKeyForInstanceAsync<PartitionByReportingNodeAndPeriod>(args)),
        ...
        {
            Id = (Guid) (await source.Partition
        ...
        {
            Id = (Guid) (await source.Partition.GetKeyForInstanceAsync<PartitionByReportingNodeAndPeriod>(
                argsScenarioMTUP)),
            ReportingNode = reportingNode,
