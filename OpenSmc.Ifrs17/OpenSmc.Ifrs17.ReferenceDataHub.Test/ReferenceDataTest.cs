...
@@AocConfiguration,
AocType,Novelty,DataType,InputSource,StructureTypes,FxPeriod,YcPeriod,CdrPeriod,ValuationPeriod,RcPeriod,Order,Year,Month
...
C,Current,20,,
@@EstimateType,
SystemName,DisplayName,Order,StructureTypes,InputSource,PeriodType
